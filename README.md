...
This repository contains all the code used to evaluate different models for ASR and the README from the whisper hindi large v2 repository used to fine-tune and evaluate.
